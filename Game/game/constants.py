...
BOARD_COLORS = [arcade.color.DIM_GRAY, arcade.color.EGGPLANT, arcade.color.GOLDEN_BROWN, arcade.color.PURPUREUS, arcade.color.PUCE_RED, arcade.color.PEACH_ORANGE, arcade.color.TEA_GREEN, arcade.color.BLUEBERRY, arcade.color.INDIGO]
TETROMINO_SOUND_PATH = ["Game/game/Assets/sound/backgroundmusic.mp3", "Game/game/Assets/sound/gameover.wav", "Game/game/Assets/sound/gamestart.wav", "Game/game/Assets/sound/tetrismovesound.wav"]